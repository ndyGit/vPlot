...
//	var myExternalObject = require([Config.basePath+'VLib/plugins/YOUR_PLUGIN/YOUR_FILE'
	...
	var plugin = (function() {
		...
		/*	require([ 'libs/tree/lib_gg_orgchart_v043' ]);
			require([ 'libs/tree/raphael-min' ]);
			require([ 'libs/tree/jsrender' ]);
			console.log('plugin[ tree ] code function called from module'+config);
*/
		...
		/*
		 * NO FACADE DUE TO "THIS" SCOPE
		 * THIS SHOULD ONLY ILLUSTRATE THE IMPORTANCE 
		 * OF THE GIVEN FUNCTION/VARIABLE NAMES.
		 * THUS DO NOT RENAME this.name and this.code :-) 
		 */
		return {
			name : this.name,
			exec : this.exec
